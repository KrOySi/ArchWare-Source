...
extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        if (ashaderoption != null) {
            int i2 = MathHelper.ceil((double)ashaderoption.length / 9.0);
            if (l1 < i2) {
                l1 = i2;
            }
            for (int j2 = 0; j2 < ashaderoption.length; ++j2) {
                ...
                int k3 = k + l2 * l;
                int l3 = i3 - 10;
                String s = GuiShaderOptions.getButtonText(shaderoption, l3);
                GuiButtonShaderOption guibuttonshaderoption = Shaders.isShaderPackOptionSlider(shaderoption.getName()) ? new GuiSliderShaderOption(i + j2, j3, k3, l3, k1, shaderoption, s) : new GuiButtonShaderOption(i + j2, j3, k3, l3, k1, shaderoption, s);
