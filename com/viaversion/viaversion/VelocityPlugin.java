...
@Plugin(id="viaversion", name="ViaVersion", version="4.0.1-1.17.1-rc1-SNAPSHOT", authors={"_MylesC", "creeper123123321", "Gerrygames", "KennyTV", "Matsv"}, description="Allow newer Minecraft versions to connect to an older server version.", url="https://viaversion.com")
...
implements ViaPlatform<Player> {
    ...
    public String getPluginVersion() {
        return "4.0.1-1.17.1-rc1-SNAPSHOT";
    }
