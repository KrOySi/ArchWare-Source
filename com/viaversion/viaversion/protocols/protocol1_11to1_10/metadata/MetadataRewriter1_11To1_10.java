...
extends EntityRewriter<Protocol1_11To1_10> {
    ...
    protected void handleMetadata(int entityId, EntityType type, Metadata metadata, List<Metadata> metadatas, UserConnection connection) {
        ...
        if (type.is((EntityType)Entity1_11Types.EntityType.ARMOR_STAND) && Via.getConfig().isHologramPatch()) {
            ...
            if (metadata.id() == 0 && flags != null && customName != null && customNameVisible != null && ((data = ((Byte)metadata.getValue()).byteValue()) & 0x20) == 32 && ((Byte)flags.getValue() & 1) == 1 && !((String)customName.getValue()).isEmpty() && ((Boolean)customNameVisible.getValue()).booleanValue() && !(tracker = (EntityTracker1_11)this.tracker(connection)).isHologram(entityId)) {
