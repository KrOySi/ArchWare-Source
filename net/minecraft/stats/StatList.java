...
public class StatList {
    ...
    private static void initCraftableStats() {
        ...
        StatList.replaceAllSimilarBlocks(CRAFTS_STATS);
    }
    ...
    private static void initMiningStats() {
        ...
        StatList.replaceAllSimilarBlocks(BLOCKS_STATS);
    }
    ...
    private static void initStats() {
        ...
        StatList.replaceAllSimilarBlocks(OBJECT_USE_STATS);
    }
    ...
    private static void initItemDepleteStats() {
        ...
        StatList.replaceAllSimilarBlocks(OBJECT_BREAK_STATS);
    }
    ...
    private static void replaceAllSimilarBlocks(StatBase[] stat) {
        StatList.mergeStatBases(stat, Blocks.WATER, Blocks.FLOWING_WATER);
        StatList.mergeStatBases(stat, Blocks.LAVA, Blocks.FLOWING_LAVA);
        StatList.mergeStatBases(stat, Blocks.LIT_PUMPKIN, Blocks.PUMPKIN);
        StatList.mergeStatBases(stat, Blocks.LIT_FURNACE, Blocks.FURNACE);
        StatList.mergeStatBases(stat, Blocks.LIT_REDSTONE_ORE, Blocks.REDSTONE_ORE);
        StatList.mergeStatBases(stat, Blocks.POWERED_REPEATER, Blocks.UNPOWERED_REPEATER);
        StatList.mergeStatBases(stat, Blocks.POWERED_COMPARATOR, Blocks.UNPOWERED_COMPARATOR);
        StatList.mergeStatBases(stat, Blocks.REDSTONE_TORCH, Blocks.UNLIT_REDSTONE_TORCH);
        StatList.mergeStatBases(stat, Blocks.LIT_REDSTONE_LAMP, Blocks.REDSTONE_LAMP);
        StatList.mergeStatBases(stat, Blocks.DOUBLE_STONE_SLAB, Blocks.STONE_SLAB);
        StatList.mergeStatBases(stat, Blocks.DOUBLE_WOODEN_SLAB, Blocks.WOODEN_SLAB);
        StatList.mergeStatBases(stat, Blocks.DOUBLE_STONE_SLAB2, Blocks.STONE_SLAB2);
        StatList.mergeStatBases(stat, Blocks.GRASS, Blocks.DIRT);
        StatList.mergeStatBases(stat, Blocks.FARMLAND, Blocks.DIRT);
    }
