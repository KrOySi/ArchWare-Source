        ...
        for (int j2 = j - 16; j2 <= j + 16; ++j2) {
            ...
            for (int l2 = l - 16; l2 <= l + 16; ++l2) {
                ...
                block2: for (int j3 = this.worldServerInstance.getActualHeight() - 1; j3 >= 0; --j3) {
                    if (!this.worldServerInstance.isAirBlock(blockpos$mutableblockpos.setPos(j2, j3, l2))) continue;
                        ...
                        for (int j4 = 0; j4 < 3; ++j4) {
                            for (int k4 = 0; k4 < 4; ++k4) {
                                for (int l4 = -1; l4 < 4; ++l4) {
                                    ...
                                    if (l4 < 0 && !this.worldServerInstance.getBlockState(blockpos$mutableblockpos).getMaterial().isSolid() || l4 >= 0 && !this.worldServerInstance.isAirBlock(blockpos$mutableblockpos)) continue block2;
                                }
                            }
                        }
            ...
            for (int l5 = j - 16; l5 <= j + 16; ++l5) {
                ...
                for (int j6 = l - 16; j6 <= l + 16; ++j6) {
                    ...
                    block10: for (int i7 = this.worldServerInstance.getActualHeight() - 1; i7 >= 0; --i7) {
                        if (!this.worldServerInstance.isAirBlock(blockpos$mutableblockpos.setPos(l5, i7, j6))) continue;
                        ...
                        for (int k7 = i2; k7 < i2 + 2; ++k7) {
                            ...
                            for (int j10 = 0; j10 < 4; ++j10) {
                                for (int j11 = -1; j11 < 4; ++j11) {
                                    ...
                                    if (j11 < 0 && !this.worldServerInstance.getBlockState(blockpos$mutableblockpos).getMaterial().isSolid() || j11 >= 0 && !this.worldServerInstance.isAirBlock(blockpos$mutableblockpos)) continue block10;
                                }
                            }
