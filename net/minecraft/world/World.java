...
implements IBlockAccess {
    ...
    public <T extends Entity> List<T> getEntities(Class<? extends T> entityType, Predicate<? super T> filter) {
        ...
        for (Entity entity4 : this.loadedEntityList) {
            if (!entityType.isAssignableFrom(entity4.getClass()) || !filter.apply((Object)entity4)) continue;
            list.add(entity4);
        }
        return list;
    }
    ...
    public <T extends Entity> T findNearestEntityWithinAABB(Class<? extends T> entityType, AxisAlignedBB aabb, T closestTo) {
        ...
        for (int j2 = 0; j2 < list.size(); ++j2) {
            ...
            if (t1 == closestTo || !EntitySelectors.NOT_SPECTATING.apply((Object)t1) || !((d1 = closestTo.getDistanceSqToEntity(t1)) <= d0)) continue;
            t = t1;
            d0 = d1;
        }
        return (T)t;
    ...
    public EntityPlayer func_190525_a(double p_190525_1_, double p_190525_3_, double p_190525_5_, double p_190525_7_, Predicate<Entity> p_190525_9_) {
        ...
        for (int j2 = 0; j2 < this.playerEntities.size(); ++j2) {
            ...
            if (!p_190525_9_.apply((Object)entityplayer1)) continue;
    ...
    public EntityPlayer getNearestAttackablePlayer(Entity entityIn, double maxXZDistance, double maxYDistance) {
        return this.getNearestAttackablePlayer(entityIn.posX, entityIn.posY, entityIn.posZ, maxXZDistance, maxYDistance, (Function<EntityPlayer, Double>)((Function)null), (Predicate<EntityPlayer>)((Predicate)null));
    }

    @Nullable
    public EntityPlayer getNearestAttackablePlayer(BlockPos pos, double maxXZDistance, double maxYDistance) {
        return this.getNearestAttackablePlayer((float)pos.getX() + 0.5f, (float)pos.getY() + 0.5f, (float)pos.getZ() + 0.5f, maxXZDistance, maxYDistance, (Function<EntityPlayer, Double>)((Function)null), (Predicate<EntityPlayer>)((Predicate)null));
    }
    ...
    public EntityPlayer getNearestAttackablePlayer(double posX, double posY, double posZ, double maxXZDistance, double maxYDistance, @Nullable Function<EntityPlayer, Double> playerToDouble, @Nullable Predicate<EntityPlayer> p_184150_12_) {
        ...
        for (int j2 = 0; j2 < this.playerEntities.size(); ++j2) {
            EntityPlayer entityplayer1 = this.playerEntities.get(j2);
            if (entityplayer1.capabilities.disableDamage || !entityplayer1.isEntityAlive() || entityplayer1.isSpectator() || p_184150_12_ != null && !p_184150_12_.apply((Object)entityplayer1)) continue;
            ...
            if (playerToDouble != null) {
                d2 *= ((Double)MoreObjects.firstNonNull((Object)playerToDouble.apply((Object)entityplayer1), (Object)1.0)).doubleValue();
            }
