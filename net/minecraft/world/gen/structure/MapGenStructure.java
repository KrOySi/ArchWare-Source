...
extends MapGenBase {
    ...
    public synchronized boolean generateStructure(World worldIn, Random randomIn, ChunkPos chunkCoord) {
        ...
        for (StructureStart structurestart : this.structureMap.values()) {
            if (!structurestart.isSizeableStructure() || !structurestart.isValidForPostProcess(chunkCoord) || !structurestart.getBoundingBox().intersectsWith(i, j, i + 15, j + 15)) continue;
            ...
            for (int l = -k; l <= k; ++l) {
                ...
                for (int i1 = -k; i1 <= k; ++i1) {
                    ...
                    if (p_191069_1_.canSpawnStructureAtCoords(l1, i2)) {
                        if (p_191069_8_ && p_191069_0_.func_190526_b(l1, i2)) continue;
