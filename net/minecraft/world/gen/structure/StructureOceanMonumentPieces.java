...
public class StructureOceanMonumentPieces {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            boolean bl = flag = this.mainDesign != 0 && randomIn.nextBoolean() && !this.roomDefinition.hasOpening[EnumFacing.DOWN.getIndex()] && !this.roomDefinition.hasOpening[EnumFacing.UP.getIndex()] && this.roomDefinition.countOpenings() > 1;
            if (this.mainDesign == 0) {
    ...
    static class RoomDefinition {
        ...
        public boolean findSource(int p_175959_1_) {
            ...
            for (int i = 0; i < 6; ++i) {
                if (this.connections[i] == null || !this.hasOpening[i] || this.connections[i].scanIndex == p_175959_1_ || !this.connections[i].findSource(p_175959_1_)) continue;
                return true;
            }
            return false;
        }
    ...
    extends StructureComponent {
            ...
            for (int i = p_181655_4_; i <= p_181655_7_; ++i) {
                for (int j = p_181655_3_; j <= p_181655_6_; ++j) {
                    for (int k = p_181655_5_; k <= p_181655_8_; ++k) {
                        if (p_181655_9_ && this.getBlockStateFromPos(p_181655_1_, j, i, k, p_181655_2_).getMaterial() == Material.AIR) continue;
            ...
            for (int i = p_175819_4_; i <= p_175819_7_; ++i) {
                for (int j = p_175819_3_; j <= p_175819_6_; ++j) {
                    for (int k = p_175819_5_; k <= p_175819_8_; ++k) {
                        if (this.getBlockStateFromPos(worldIn, j, i, k, p_175819_2_) != WATER) continue;
        ...
        protected boolean spawnElder(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
            ...
            if (p_175817_2_.isVecInside(new BlockPos(i, j = this.getYWithOffset(p_175817_4_), k = this.getZWithOffset(p_175817_3_, p_175817_5_)))) {
                ...
                entityelderguardian.setLocationAndAngles((double)i + 0.5, j, (double)k + 0.5, 0.0f, 0.0f);
    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            this.boundingBox = enumfacing.getAxis() == EnumFacing.Axis.Z ? new StructureBoundingBox(p_i45599_2_, 39, p_i45599_3_, p_i45599_2_ + 58 - 1, 61, p_i45599_3_ + 58 - 1) : new StructureBoundingBox(p_i45599_2_, 39, p_i45599_3_, p_i45599_2_ + 58 - 1, 61, p_i45599_3_ + 58 - 1);
            ...
            block0: for (RoomDefinition structureoceanmonumentpieces$roomdefinition : list) {
                if (structureoceanmonumentpieces$roomdefinition.claimed || structureoceanmonumentpieces$roomdefinition.isSpecial()) continue;
                for (Object structureoceanmonumentpieces$monumentroomfithelper : list1) {
                    if (!structureoceanmonumentpieces$monumentroomfithelper.fits(structureoceanmonumentpieces$roomdefinition)) continue;
        ...
        private List<RoomDefinition> generateRoomGraph(Random p_175836_1_) {
                ...
                for (int j3 = 0; j3 < 5; ++j3) {
                    for (int i4 = 0; i4 < 3; ++i4) {
                        ...
                        for (EnumFacing enumfacing : EnumFacing.values()) {
                            ...
                            if (i1 < 0 || i1 >= 5 || k1 < 0 || k1 >= 5 || j1 < 0 || j1 >= 3 || astructureoceanmonumentpieces$roomdefinition[l1 = MonumentBuilding.getRoomIndex(i1, j1, k1)] == null) continue;
                            if (k1 == j3) {
            ...
            this.coreRoom = astructureoceanmonumentpieces$roomdefinition[MonumentBuilding.getRoomIndex(p_175836_1_.nextInt(4), 0, 2)];
            ...
            for (RoomDefinition structureoceanmonumentpieces$roomdefinition4 : astructureoceanmonumentpieces$roomdefinition) {
                if (structureoceanmonumentpieces$roomdefinition4 == null) continue;
            ...
            for (RoomDefinition structureoceanmonumentpieces$roomdefinition3 : list) {
                ...
                for (int k5 = 0; j5 < 2 && k5 < 5; ++k5) {
                    ...
                    if (!structureoceanmonumentpieces$roomdefinition3.hasOpening[l5]) continue;
