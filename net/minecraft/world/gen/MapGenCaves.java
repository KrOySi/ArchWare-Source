                        ...
                        for (int j3 = k2; j3 < k; ++j3) {
                            ...
                            for (int i2 = i3; i2 < i1; ++i2) {
                                ...
                                for (int j2 = l; j2 > l2; --j2) {
                                    ...
                                    IBlockState iblockstate2 = (IBlockState)MoreObjects.firstNonNull((Object)p_180702_5_.getBlockState(j3, j2 + 1, i2), (Object)BLK_AIR);
                                    ...
                                    p_180702_5_.setBlockState(j3, j2 - 1, i2, this.worldObj.getBiome((BlockPos)blockpos$mutableblockpos).topBlock.getBlock().getDefaultState());
                                }
                            }
                        }
                        if (flag2) break;
    ...
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            for (int l = 0; l < k; ++l) {
                ...
                this.addTunnel(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f2, f, f1, 0, 0, 1.0);
            }
        }
    }
}
