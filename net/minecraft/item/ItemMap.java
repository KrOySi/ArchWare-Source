        ...
        if (worldIn.provider.getDimensionType().getId() == data.dimension && viewer instanceof EntityPlayer) {
            ...
            for (int k1 = l - j1 + 1; k1 < l + j1; ++k1) {
                ...
                for (int l1 = i1 - j1 - 1; l1 < i1 + j1; ++l1) {
                            ...
                            for (int j4 = 0; j4 < i; ++j4) {
                                ...
                                if (k4 <= 1) {
                                    ...
                                    do {
                                        ...
                                        blockpos$mutableblockpos.setPos((chunk.xPosition << 4) + i4 + i3, k4, (chunk.zPosition << 4) + j4 + j3);
                    ...
                    if ((mapcolor = (MapColor)Iterables.getFirst((Iterable)Multisets.copyHighestCountFirst((Multiset)multiset), (Object)MapColor.AIR)) == MapColor.WATER) {
