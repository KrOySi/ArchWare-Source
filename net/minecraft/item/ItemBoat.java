...
extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World itemStackIn, EntityPlayer worldIn, EnumHand playerIn) {
        ...
        boolean flag = false;
        List<Entity> list = itemStackIn.getEntitiesWithinAABBExcludingEntity(worldIn, worldIn.getEntityBoundingBox().addCoord(vec3d2.xCoord * 5.0, vec3d2.yCoord * 5.0, vec3d2.zCoord * 5.0).expandXyz(1.0));
        ...
        EntityBoat entityboat = new EntityBoat(itemStackIn, raytraceresult.hitVec.xCoord, flag1 ? raytraceresult.hitVec.yCoord - 0.12 : raytraceresult.hitVec.yCoord, raytraceresult.hitVec.zCoord);
