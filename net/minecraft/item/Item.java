...
public class Item {
    ...
    public EnumActionResult onItemUseCus(EntityPlayer stack, World playerIn, BlockPos worldIn, ItemStack pos, EnumFacing hand, float facing, float hitX, float hitY) {
        return EnumActionResult.PASS;
    }
    ...
    protected RayTraceResult rayTrace(World worldIn, EntityPlayer playerIn, boolean useLiquids) {
        ...
        float f7 = f2 * f4;
        double d3 = 5.0;
        Vec3d vec3d1 = vec3d.addVector((double)f6 * 5.0, (double)f5 * 5.0, (double)f7 * 5.0);
    ...
    public static void registerItems() {
        ...
        Item.registerItemBlock(Blocks.field_190976_dk);
        Item.registerItemBlock(Blocks.field_190977_dl, new ItemShulkerBox(Blocks.field_190977_dl));
        Item.registerItemBlock(Blocks.field_190978_dm, new ItemShulkerBox(Blocks.field_190978_dm));
        Item.registerItemBlock(Blocks.field_190979_dn, new ItemShulkerBox(Blocks.field_190979_dn));
        Item.registerItemBlock(Blocks.field_190980_do, new ItemShulkerBox(Blocks.field_190980_do));
        Item.registerItemBlock(Blocks.field_190981_dp, new ItemShulkerBox(Blocks.field_190981_dp));
        Item.registerItemBlock(Blocks.field_190982_dq, new ItemShulkerBox(Blocks.field_190982_dq));
        Item.registerItemBlock(Blocks.field_190983_dr, new ItemShulkerBox(Blocks.field_190983_dr));
        Item.registerItemBlock(Blocks.field_190984_ds, new ItemShulkerBox(Blocks.field_190984_ds));
        Item.registerItemBlock(Blocks.field_190985_dt, new ItemShulkerBox(Blocks.field_190985_dt));
        Item.registerItemBlock(Blocks.field_190986_du, new ItemShulkerBox(Blocks.field_190986_du));
        Item.registerItemBlock(Blocks.field_190987_dv, new ItemShulkerBox(Blocks.field_190987_dv));
        Item.registerItemBlock(Blocks.field_190988_dw, new ItemShulkerBox(Blocks.field_190988_dw));
        Item.registerItemBlock(Blocks.field_190989_dx, new ItemShulkerBox(Blocks.field_190989_dx));
        Item.registerItemBlock(Blocks.field_190990_dy, new ItemShulkerBox(Blocks.field_190990_dy));
        Item.registerItemBlock(Blocks.field_190991_dz, new ItemShulkerBox(Blocks.field_190991_dz));
        Item.registerItemBlock(Blocks.field_190975_dA, new ItemShulkerBox(Blocks.field_190975_dA));
