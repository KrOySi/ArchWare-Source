...
extends Item {
    ...
    public EnumActionResult onItemUseCus(EntityPlayer stack, World playerIn, BlockPos worldIn, ItemStack pos, EnumFacing hand, float facing, float hitX, float hitY) {
        ...
        if (!(itemstack = pos).func_190926_b() && stack.canPlayerEdit(worldIn, hand, itemstack) && playerIn.func_190527_a(this.block, worldIn, false, hand, null)) {
    ...
    public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) {
        ...
        if (!(itemstack = stack.getHeldItem(pos)).func_190926_b() && stack.canPlayerEdit(worldIn, hand, itemstack) && playerIn.func_190527_a(this.block, worldIn, false, hand, null)) {
            int i = this.getMetadata(itemstack.getMetadata());
            IBlockState iblockstate1 = this.block.onBlockPlaced(playerIn, worldIn, hand, facing, hitX, hitY, i, stack);
            if (playerIn.setBlockState(worldIn, iblockstate1, 11)) {
                iblockstate1 = playerIn.getBlockState(worldIn);
    ...
    public boolean canPlaceBlockOnSide(World worldIn, BlockPos pos, EnumFacing side, EntityPlayer player, ItemStack stack) {
        ...
        return worldIn.func_190527_a(this.block, pos, false, side, player);
    }
