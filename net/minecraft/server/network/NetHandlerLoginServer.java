...
ITickable {
    ...
    public void func_194026_b(ITextComponent p_194026_1_) {
        try {
            LOGGER.info("Disconnecting {}: {}", (Object)this.getConnectionInfo(), (Object)p_194026_1_.getUnformattedText());
    ...
    public void onDisconnect(ITextComponent reason) {
        LOGGER.info("{} lost connection: {}", (Object)this.getConnectionInfo(), (Object)reason.getUnformattedText());
    }

    public String getConnectionInfo() {
        return this.loginGameProfile != null ? (Object)this.loginGameProfile + " (" + this.networkManager.getRemoteAddress() + ")" : String.valueOf(this.networkManager.getRemoteAddress());
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (NetHandlerLoginServer.this.loginGameProfile != null) {
                        LOGGER.info("UUID of player {} is {}", (Object)NetHandlerLoginServer.this.loginGameProfile.getName(), (Object)NetHandlerLoginServer.this.loginGameProfile.getId());
