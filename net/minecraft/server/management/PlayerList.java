...
public abstract class PlayerList {
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn) {
        ...
        LOG.info("{}[{}] logged in with entity id {} at ({}, {}, {})", (Object)playerIn.getName(), (Object)s1, (Object)playerIn.getEntityId(), (Object)playerIn.posX, (Object)playerIn.posY, (Object)playerIn.posZ);
    ...
    public EntityPlayerMP createPlayerForUser(GameProfile profile) {
        ...
        PlayerInteractionManager playerinteractionmanager = this.mcServer.isDemo() ? new DemoPlayerInteractionManager(this.mcServer.worldServerForDimension(0)) : new PlayerInteractionManager(this.mcServer.worldServerForDimension(0));
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd) {
        ...
        PlayerInteractionManager playerinteractionmanager = this.mcServer.isDemo() ? new DemoPlayerInteractionManager(this.mcServer.worldServerForDimension(playerIn.dimension)) : new PlayerInteractionManager(this.mcServer.worldServerForDimension(playerIn.dimension));
