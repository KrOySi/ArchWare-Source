...
extends Block {
    ...
    public static enum EnumRailDirection implements IStringSerializable
    {
        ...
        static {
            ...
            EnumRailDirection[] arrenumRailDirection = EnumRailDirection.values();
            int n = arrenumRailDirection.length;
            for (int i = 0; i < n; ++i) {
                EnumRailDirection blockrailbase$enumraildirection;
                EnumRailDirection.META_LOOKUP[blockrailbase$enumraildirection.getMetadata()] = blockrailbase$enumraildirection = arrenumRailDirection[i];
            }
        }
    }
}
