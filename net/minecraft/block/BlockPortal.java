...
extends BlockBreakable {
        ...
        for (EnumFacing.AxisDirection enumfacing$axisdirection : EnumFacing.AxisDirection.values()) {
            ...
            for (int i = 0; i < blockportal$size.getWidth(); ++i) {
                for (int j = 0; j < blockportal$size.getHeight(); ++j) {
                    ...
                    if (blockworldstate.getBlockState() == null || blockworldstate.getBlockState().getMaterial() == Material.AIR) continue;
    ...
    public static class Size {
        ...
        protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
            BlockPos blockpos;
            int i;
            for (i = 0; i < 22 && this.isEmptyBlock(this.world.getBlockState(blockpos = p_180120_1_.offset(p_180120_2_, i)).getBlock()) && this.world.getBlockState(blockpos.down()).getBlock() == Blocks.OBSIDIAN; ++i) {
            }
        ...
        protected int calculatePortalHeight() {
            ...
            for (int j = 0; j < this.width; ++j) {
                if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() == Blocks.OBSIDIAN) continue;
                this.height = 0;
                break;
            }
