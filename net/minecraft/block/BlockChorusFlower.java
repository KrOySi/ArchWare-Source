            ...
            if (worldIn.isAirBlock(blockpos) && blockpos.getY() < 256 && (i = state.getValue(AGE).intValue()) < 5 && rand.nextInt(1) == 0) {
                ...
                if (flag && BlockChorusFlower.areAllNeighborsEmpty(worldIn, blockpos, null) && worldIn.isAirBlock(pos.up(2))) {
                    ...
                    for (int j1 = 0; j1 < l; ++j1) {
                        ...
                        if (!worldIn.isAirBlock(blockpos1) || !worldIn.isAirBlock(blockpos1.down()) || !BlockChorusFlower.areAllNeighborsEmpty(worldIn, blockpos1, enumfacing.getOpposite())) continue;
    ...
    private static void growTreeRecursive(World worldIn, BlockPos p_185601_1_, Random rand, BlockPos p_185601_3_, int p_185601_4_, int p_185601_5_) {
        ...
        if (p_185601_5_ < 4) {
            ...
            for (int k = 0; k < l; ++k) {
                ...
                if (Math.abs(blockpos1.getX() - p_185601_3_.getX()) >= p_185601_4_ || Math.abs(blockpos1.getZ() - p_185601_3_.getZ()) >= p_185601_4_ || !worldIn.isAirBlock(blockpos1) || !worldIn.isAirBlock(blockpos1.down()) || !BlockChorusFlower.areAllNeighborsEmpty(worldIn, blockpos1, enumfacing.getOpposite())) continue;
                flag = true;
