...
extends CommandBase {
    ...
    private void func_193516_a(MinecraftServer p_193516_1_, ICommandSender p_193516_2_, String[] p_193516_3_, EntityPlayerMP p_193516_4_, ActionType p_193516_5_, Mode p_193516_6_) throws CommandException {
        if (p_193516_6_ == Mode.EVERYTHING) {
            ...
            if (p_193516_6_ == Mode.ONLY && p_193516_3_.length == 5) {
                ...
                AdvancementCommand.notifyCommandListener(p_193516_2_, (ICommand)this, p_193516_5_.field_193541_d + ".criterion.success", advancement.func_192067_g(), p_193516_4_.getName(), s);
                return;
            } else {
                if (p_193516_3_.length != 4) {
                    throw p_193516_6_.func_193544_a(p_193516_5_);
    ...
    public List<String> getTabCompletionOptions(MinecraftServer server, ICommandSender sender, String[] args, @Nullable BlockPos pos) {
        ...
        if (advancementcommand$actiontype != null) {
            ...
            if (advancementcommand$mode != null && advancementcommand$mode != Mode.EVERYTHING) {
                ...
                if (args.length == 5 && advancementcommand$mode == Mode.ONLY && (advancement = server.func_191949_aK().func_192778_a(new ResourceLocation(args[3]))) != null) {
    ...
    static enum Mode {
        ...
        void func_193546_a(ICommandSender p_193546_1_, AdvancementCommand p_193546_2_, ActionType p_193546_3_, Object ... p_193546_4_) {
            CommandBase.notifyCommandListener(p_193546_1_, (ICommand)p_193546_2_, p_193546_3_.field_193541_d + "." + this.field_193554_g + ".success", p_193546_4_);
        }

        @Nullable
        static Mode func_193547_a(String p_193547_0_) {
            for (Mode advancementcommand$mode : Mode.values()) {
                if (!advancementcommand$mode.field_193554_g.equals(p_193547_0_)) continue;
    ...
    static enum ActionType {
        ...
        static ActionType func_193536_a(String p_193536_0_) {
            for (ActionType advancementcommand$actiontype : ActionType.values()) {
                if (!advancementcommand$actiontype.field_193540_c.equals(p_193536_0_)) continue;
