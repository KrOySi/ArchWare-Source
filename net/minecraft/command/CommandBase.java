...
implements ICommand {
    ...
    public static NBTTagCompound entityToNBT(Entity theEntity) {
        ...
        if (theEntity instanceof EntityPlayer && !(itemstack = ((EntityPlayer)theEntity).inventory.getCurrentItem()).func_190926_b()) {
    ...
    public static List<EntityPlayerMP> func_193513_a(MinecraftServer p_193513_0_, ICommandSender p_193513_1_, String p_193513_2_) throws CommandException {
        ArrayList list = EntitySelector.func_193531_b(p_193513_1_, p_193513_2_);
        return list.isEmpty() ? Lists.newArrayList((Object[])new EntityPlayerMP[]{CommandBase.func_193512_a(p_193513_0_, null, p_193513_2_)}) : list;
    }
    ...
    private static Map<IProperty<?>, Comparable<?>> func_190795_c(Block p_190795_0_, String p_190795_1_) throws InvalidBlockStateException {
        ...
        Iterator iterator = field_190796_b.split((CharSequence)p_190795_1_).iterator();
        while (true) {
            Object comparable;
            IProperty<?> iproperty;
            if (!iterator.hasNext()) {
            ...
            Iterator iterator1 = field_190797_c.split((CharSequence)s).iterator();
            if (!iterator1.hasNext() || (iproperty = blockstatecontainer.getProperty((String)iterator1.next())) == null || !iterator1.hasNext() || (comparable = CommandBase.func_190792_a(iproperty, (String)iterator1.next())) == null) break;
    ...
    static {
        field_190796_b = Splitter.on((char)',');
        field_190797_c = Splitter.on((char)'=').limit(2);
    }
