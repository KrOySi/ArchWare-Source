                        ...
                        for (int j1 = blockpos2.getX(); j1 <= blockpos3.getX(); ++j1) {
                            ...
                            block17: {
                                block18: {
                                    ...
                                    if (world.getBlockState(blockpos4).getBlock() != block1 || args.length > 10 && !"-1".equals(args[10]) && !"*".equals(args[10]) && !CommandBase.func_190791_b(block1, args[10]).apply((Object)world.getBlockState(blockpos4))) {
                                        continue;
                                    }
                                    break block17;
                                }
