...
public class EntitySelector {
    ...
    private static final Splitter field_190828_b = Splitter.on((char)',').omitEmptyStrings();
    private static final Splitter field_190829_c = Splitter.on((char)'=').limit(2);
    ...
    private static final Set<String> WORLD_BINDING_ARGS = Sets.newHashSet((Object[])new String[]{field_190835_i, field_190836_j, field_190837_k, field_190838_l, field_190839_m, field_190840_n, field_190832_f, field_190831_e});
            ...
            for (World world : list) {
                ...
                if ("s".equalsIgnoreCase(s)) {
                    ...
                    if (entity != null && targetClass.isAssignableFrom(entity.getClass())) {
                        ...
                        if ((map.containsKey(field_190838_l) || map.containsKey(field_190839_m) || map.containsKey(field_190840_n)) && !(axisalignedbb = EntitySelector.getAABB(blockpos, i = EntitySelector.getInt(map, field_190838_l, 0), j = EntitySelector.getInt(map, field_190839_m, 0), k = EntitySelector.getInt(map, field_190840_n, 0))).intersectsWith(entity.getEntityBoundingBox())) {
                            return Collections.emptyList();
                        }
    ...
    private static Map<String, String> getArgumentMap(@Nullable String argumentString) throws CommandException {
        ...
        for (String s : field_190828_b.split((CharSequence)argumentString)) {
            Iterator iterator = field_190829_c.split((CharSequence)s).iterator();
            String s1 = (String)iterator.next();
            if (!field_190851_y.apply((Object)s1)) {
