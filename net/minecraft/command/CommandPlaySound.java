...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        double d0 = args.length > i ? CommandPlaySound.parseDouble(vec3d.xCoord, args[i++], true) : vec3d.xCoord;
        double d1 = args.length > i ? CommandPlaySound.parseDouble(vec3d.yCoord, args[i++], 0, 0, false) : vec3d.yCoord;
        double d2 = args.length > i ? CommandPlaySound.parseDouble(vec3d.zCoord, args[i++], true) : vec3d.zCoord;
