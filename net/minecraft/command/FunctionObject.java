...
public class FunctionObject {
    ...
    public static FunctionObject func_193527_a(FunctionManager p_193527_0_, List<String> p_193527_1_) {
        ArrayList list = Lists.newArrayListWithCapacity((int)p_193527_1_.size());
        for (String s : p_193527_1_) {
            if ((s = s.trim()).startsWith("#") || s.isEmpty()) continue;
    ...
    implements Entry {
        ...
        public void func_194145_a(FunctionManager p_194145_1_, ICommandSender p_194145_2_, ArrayDeque<FunctionManager.QueuedCommand> p_194145_3_, int p_194145_4_) {
            ...
            if (functionobject != null) {
                Entry[] afunctionobject$entry = functionobject.func_193528_a();
    ...
    public static interface Entry {
        public void func_194145_a(FunctionManager var1, ICommandSender var2, ArrayDeque<FunctionManager.QueuedCommand> var3, int var4);
    }
