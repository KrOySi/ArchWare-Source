...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (scoreobjective != null && scoreobjective.getCriteria() == IScoreCriteria.TRIGGER) {
            ...
            if (entityplayermp.interactionManager.isCreative()) {
                CommandTrigger.notifyCommandListener(sender, (ICommand)this, "commands.trigger.success", args[0], args[1], args[2]);
            }
        } else {
            throw new CommandException("commands.trigger.invalidObjective", args[0]);
        }
    ...
    public List<String> getTabCompletionOptions(MinecraftServer server, ICommandSender sender, String[] args, @Nullable BlockPos pos) {
        ...
        return args.length == 2 ? CommandTrigger.getListOfStringsMatchingLastWord(args, "add", "set") : Collections.emptyList();
    }
}
