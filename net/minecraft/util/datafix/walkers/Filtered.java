...
implements IDataWalker {
    ...
    public Filtered(Class<?> p_i47309_1_) {
        this.key = Entity.class.isAssignableFrom(p_i47309_1_) ? EntityList.func_191306_a(p_i47309_1_) : (TileEntity.class.isAssignableFrom(p_i47309_1_) ? TileEntity.func_190559_a(p_i47309_1_) : null);
    }
