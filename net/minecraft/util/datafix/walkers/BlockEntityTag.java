...
implements IDataWalker {
    ...
    private static String getBlockEntityID(int blockID, String p_188267_1_) {
        return blockID < 515 ? field_190892_b.get(new ResourceLocation(p_188267_1_).toString()) : ITEM_ID_TO_BLOCK_ENTITY_ID.get(new ResourceLocation(p_188267_1_).toString());
    }
    ...
    public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
        ...
        if (nbttagcompound.hasKey("BlockEntityTag", 10)) {
            ...
            String s1 = BlockEntityTag.getBlockEntityID(versionIn, s);
            if (s1 == null) {
