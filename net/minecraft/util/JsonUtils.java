...
public class JsonUtils {
    ...
    public static String toString(JsonElement json) {
        String s = StringUtils.abbreviateMiddle((String)String.valueOf((Object)json), (String)"...", (int)10);
        if (json == null) {
            return "null (missing)";
        }
        if (json.isJsonNull()) {
    ...
    public static <T> T func_193838_a(Gson p_193838_0_, Reader p_193838_1_, Type p_193838_2_, boolean p_193838_3_) {
        try {
            ...
            return (T)p_193838_0_.getAdapter(TypeToken.get((Type)p_193838_2_)).read(jsonreader);
        }
        catch (IOException ioexception) {
            throw new JsonParseException((Throwable)ioexception);
        }
