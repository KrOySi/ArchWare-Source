...
implements IReloadableResourceManager {
    ...
    public void reloadResources(List<IResourcePack> resourcesPacksList) {
        this.clearResources();
        LOGGER.info("Reloading ResourceManager: {}", (Object)JOINER_RESOURCE_PACKS.join(Iterables.transform(resourcesPacksList, (Function)new Function<IResourcePack, String>(){
