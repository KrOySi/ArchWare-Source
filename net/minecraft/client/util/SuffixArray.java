...
public class SuffixArray<T> {
    ...
    private void func_194060_b() {
        for (int i2 = 0; i2 < this.field_194067_g.size(); ++i2) {
            field_194064_d.debug("{} {}", (Object)i2, (Object)this.func_194059_a(i2));
        }
    ...
    public List<T> func_194055_a(String p_194055_1_) {
        ...
        while (j2 < k2) {
            ...
            if (field_194062_b) {
                field_194064_d.debug("comparing lower \"{}\" with {} \"{}\": {}", (Object)p_194055_1_, (Object)l2, (Object)this.func_194059_a(l2), (Object)i3);
            }
            if (i3 > 0) {
                j2 = l2 + 1;
                continue;
        ...
        if (j2 >= 0 && j2 < i2) {
            ...
            while (j2 < k2) {
                ...
                if (field_194062_b) {
                    field_194064_d.debug("comparing upper \"{}\" with {} \"{}\": {}", (Object)p_194055_1_, (Object)j4, (Object)this.func_194059_a(j4), (Object)j3);
                }
                if (j3 >= 0) {
                    j2 = j4 + 1;
                    continue;
