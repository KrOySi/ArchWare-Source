...
implements Comparable<KeyBinding> {
    ...
    public static final IntHashMap<KeyBinding> HASH = new IntHashMap();
    public static final Set<String> KEYBIND_SET = Sets.newHashSet();
    public static final Map<String, Integer> field_193627_d = Maps.newHashMap();
