...
implements ITutorialStep {
    private static final ITextComponent field_193254_a = new TextComponentTranslation("tutorial.move.title", Tutorial.func_193291_a("forward"), Tutorial.func_193291_a("left"), Tutorial.func_193291_a("back"), Tutorial.func_193291_a("right"));
    private static final ITextComponent field_193255_b = new TextComponentTranslation("tutorial.move.description", Tutorial.func_193291_a("jump"));
    ...
    public void func_193249_a(MouseHelper p_193249_1_) {
        if ((double)MathHelper.abs(p_193249_1_.deltaX) > 0.01 || (double)MathHelper.abs(p_193249_1_.deltaY) > 0.01) {
