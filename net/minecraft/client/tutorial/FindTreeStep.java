...
implements ITutorialStep {
    private static final Set<Block> field_193268_a = Sets.newHashSet((Object[])new Block[]{Blocks.LOG, Blocks.LOG2, Blocks.LEAVES, Blocks.LEAVES2});
    ...
    public void func_193245_a() {
        ...
        if (this.field_193271_d.func_194072_f() != GameType.SURVIVAL) {
            ...
            if (this.field_193273_f == 1 && (entityplayersp = this.field_193271_d.func_193295_e().player) != null) {
    ...
    public void func_193246_a(WorldClient p_193246_1_, RayTraceResult p_193246_2_) {
        ...
        if (p_193246_2_.typeOfHit == RayTraceResult.Type.BLOCK && p_193246_2_.getBlockPos() != null && field_193268_a.contains((iblockstate = p_193246_1_.getBlockState(p_193246_2_.getBlockPos())).getBlock())) {
    ...
    public static boolean func_194070_a(EntityPlayerSP p_194070_0_) {
        for (Block block : field_193268_a) {
            ...
            if (statbase == null || p_194070_0_.getStatFileWriter().readStat(statbase) <= 0) continue;
            return true;
        }
        return false;
    }
