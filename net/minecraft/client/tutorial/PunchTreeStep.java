...
implements ITutorialStep {
    private static final Set<Block> field_193274_a = Sets.newHashSet((Object[])new Block[]{Blocks.LOG, Blocks.LOG2});
    ...
    public void func_193245_a() {
        ...
        if (this.field_193277_d.func_194072_f() != GameType.SURVIVAL) {
            ...
            if (this.field_193279_f == 1 && (entityplayersp = this.field_193277_d.func_193295_e().player) != null) {
