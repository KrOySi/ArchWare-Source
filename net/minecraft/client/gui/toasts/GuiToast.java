...
extends Gui {
    ...
    public void func_191783_a(ScaledResolution p_191783_1_) {
        if (!this.field_191790_f.gameSettings.hideGUI) {
            ...
            for (int i = 0; i < this.field_191791_g.length; ++i) {
                ...
                if (this.field_191791_g[i] != null || this.field_191792_h.isEmpty()) continue;
    ...
    public <T extends IToast> T func_192990_a(Class<? extends T> p_192990_1_, Object p_192990_2_) {
        for (ToastInstance<?> toastinstance : this.field_191791_g) {
            if (toastinstance == null || !p_192990_1_.isAssignableFrom(toastinstance.func_193685_a().getClass()) || !toastinstance.func_193685_a().func_193652_b().equals(p_192990_2_)) continue;
