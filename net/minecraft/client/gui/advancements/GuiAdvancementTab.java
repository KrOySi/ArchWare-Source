...
extends Gui {
    ...
    public void func_191799_a() {
        ...
        GuiAdvancementTab.drawRect(0.0, 0.0, 234.0, 113.0, -16777216);
        ...
        for (int k = -1; k <= 15; ++k) {
            for (int l = -1; l <= 8; ++l) {
                GuiAdvancementTab.drawModalRectWithCustomSizedTexture(i + 16 * k, j + 16 * l, 0.0f, 0.0f, 16, 16, 16.0f, 16.0f);
            }
        }
    ...
    public void func_192991_a(int p_192991_1_, int p_192991_2_, int p_192991_3_, int p_192991_4_) {
        ...
        GuiAdvancementTab.drawRect(0.0, 0.0, 234.0, 113.0, MathHelper.floor(this.field_191815_r * 255.0f) << 24);
        boolean flag = false;
        if (p_192991_1_ > 0 && p_192991_1_ < 234 && p_192991_2_ > 0 && p_192991_2_ < 113) {
            for (GuiAdvancement guiadvancement : this.field_191810_m.values()) {
                if (!guiadvancement.func_191816_c(this.field_191811_n, this.field_191812_o, p_192991_1_, p_192991_2_)) continue;
                flag = true;
        ...
        this.field_191815_r = flag ? MathHelper.clamp(this.field_191815_r + 0.02f, 0.0f, 0.3f) : MathHelper.clamp(this.field_191815_r - 0.04f, 0.0f, 1.0f);
    }
