...
public class SpectatorMenu {
    ...
    public ISpectatorMenuObject getItem(int p_178643_1_) {
        ...
        return i >= 0 && i < this.category.getItems().size() ? (ISpectatorMenuObject)MoreObjects.firstNonNull((Object)this.category.getItems().get(i), (Object)EMPTY_SLOT) : EMPTY_SLOT;
    }
