...
extends GuiButton {
    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
        if (this.visible) {
            ...
            boolean bl = flag = p_191745_2_ >= this.xPosition && p_191745_3_ >= this.yPosition && p_191745_2_ < this.xPosition + this.width && p_191745_3_ < this.yPosition + this.height;
            Icon guilockiconbutton$icon = this.locked ? (!this.enabled ? Icon.LOCKED_DISABLED : (flag ? Icon.LOCKED_HOVER : Icon.LOCKED)) : (!this.enabled ? Icon.UNLOCKED_DISABLED : (flag ? Icon.UNLOCKED_HOVER : Icon.UNLOCKED));
