...
implements IRecipeUpdateListener {
    ...
    private void func_193003_g(boolean p_193003_1_) {
        ...
        if (!s.isEmpty()) {
            ...
            list1.removeIf(arg_0 -> GuiRecipeBook.lambda$func_193003_g$3((ObjectSet)objectset, arg_0));
        }
    ...
    private static /* synthetic */ boolean lambda$func_193003_g$3(ObjectSet objectset, RecipeList p_193947_1_) {
