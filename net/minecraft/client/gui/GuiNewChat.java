        ...
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (j > 0) {
                ...
                for (int i1 = 0; i1 + this.scrollPos < this.drawnChatLines.size() && i1 < i; ++i1) {
                    ...
                    boolean i2 = false;
                    int j2 = -i1 * 9;
                    GuiNewChat.drawRect(-2.0, j2 - 9, 0 + k + 4, j2, l1 / 2 << 24);
                    String s = chatline.getChatComponent().getFormattedText();
                    GlStateManager.enableBlend();
                    this.mc.fontRendererObj.drawStringWithShadow(s, chatline.getPosX(), j2 - 8, 0xFFFFFF + (l1 << 24));
                    chatline.setPosX((float)Interpolator.EASE_OUT.interpolate((double)chatline.getPosX(), 0.0, 7.000000000000001 / (double)Minecraft.getDebugFPS()));
