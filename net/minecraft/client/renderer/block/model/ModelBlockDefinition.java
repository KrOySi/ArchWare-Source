...
public class ModelBlockDefinition {
    @VisibleForTesting
    static final Gson GSON = new GsonBuilder().registerTypeAdapter(ModelBlockDefinition.class, (Object)new Deserializer()).registerTypeAdapter(Variant.class, (Object)new Variant.Deserializer()).registerTypeAdapter(VariantList.class, (Object)new VariantList.Deserializer()).registerTypeAdapter(Multipart.class, (Object)new Multipart.Deserializer()).registerTypeAdapter(Selector.class, (Object)new Selector.Deserializer()).create();
    ...
    public Set<VariantList> getMultipartVariants() {
        HashSet set = Sets.newHashSet(this.mapVariants.values());
