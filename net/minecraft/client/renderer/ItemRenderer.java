...
public class ItemRenderer {
    ...
    private void transformSideFirstPerson(EnumHandSide p_187459_1_, float p_187459_2_) {
        ...
        GlStateManager.translate((float)i * 0.56f - ArchWare.settingManager.getSettingById("ViewModelX").getValueNumeric(), -0.52f + p_187459_2_ * -0.6f - ArchWare.settingManager.getSettingById("ViewModelY").getValueNumeric(), -0.72f - ArchWare.settingManager.getSettingById("ViewModelZ").getValueNumeric());
    }
            ...
            block10: {
                ...
                block7: {
                    ...
                    block8: {
                        ...
                        enumhand = (EnumHand)((Object)MoreObjects.firstNonNull((Object)((Object)abstractclientplayer.swingingHand), (Object)((Object)EnumHand.MAIN_HAND)));
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (this.mc.player.isBurning()) {
                if (!(Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.player, Float.valueOf(partialTicks)) || ArchWare.moduleManager.getModuleByName("NoRender").isToggled() && ArchWare.settingManager.getSettingById("NoRenderFire").getValueBoolean())) {
