...
extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        block22: {
            ...
            try {
                ...
                float f7 = entity == Minecraft.getMinecraft().player ? ((EntityLivingBase)entity).prevRotationPitch + (((EntityLivingBase)entity).rotationPitch - ((EntityLivingBase)entity).prevRotationPitch) * partialTicks : ((EntityLivingBase)entity).prevRotationPitchHead + (((EntityLivingBase)entity).rotationPitchHead - ((EntityLivingBase)entity).prevRotationPitchHead) * partialTicks;
                ((EntityLivingBase)entity).rotationPitchHead = f7;
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        boolean bl = flag1 = !flag && !((Entity)entitylivingbaseIn).isInvisibleToPlayer(Minecraft.getMinecraft().player);
        if (flag || flag1) {
            ...
            if (ArchWare.moduleManager.getModuleByName("Chams").isToggled() && entitylivingbaseIn instanceof EntityPlayer) {
                GL11.glPushMatrix();
                ...
                GL11.glColor4f((float)(ArchWare.settingManager.getSettingById("ChamsRed").getValueNumeric() / 255.0f), (float)(ArchWare.settingManager.getSettingById("ChamsGreen").getValueNumeric() / 255.0f), (float)(ArchWare.settingManager.getSettingById("ChamsBlue").getValueNumeric() / 255.0f), (float)(ArchWare.settingManager.getSettingById("ChamsOpacity").getValueNumeric() / 255.0f));
            }
    ...
    public void renderName(T entity, double x, double y, double z) {
        block7: {
            block6: {
                if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists()) break block6;
                if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, entity, this, x, y, z)) break block7;
            }
