...
public class PlayerControllerMP {
    ...
    public EnumActionResult processRightClickBlockNoSync(EntityPlayerSP player, WorldClient worldIn, BlockPos stack, EnumFacing pos, Vec3d facing, EnumHand vec) {
        ...
        if (!flag && this.currentGameType != GameType.SPECTATOR) {
            ...
            if (this.currentGameType.isCreative()) {
                ...
                EnumActionResult enumactionresult = itemstack.onItemUse((EntityPlayer)player, (World)worldIn, stack, vec, pos, f, f1, f2);
                itemstack.setItemDamage(i);
                itemstack.func_190920_e(j);
                return enumactionresult;
            }
            return itemstack.onItemUse((EntityPlayer)player, (World)worldIn, stack, vec, pos, f, f1, f2);
        }
