...
public class SoundManager {
    ...
    public void reloadSoundSystem() {
        ...
        for (SoundEvent soundevent : SoundEvent.REGISTRY) {
            ...
            LOGGER.warn("Missing sound for event: {}", (Object)SoundEvent.REGISTRY.getNameForObject(soundevent));
                        ...
                        SoundSystemConfig.setLogger((SoundSystemLogger)new SoundSystemLogger(){
                            ...
                            public void errorMessage(String p_errorMessage_1_, String p_errorMessage_2_, int p_errorMessage_3_) {
                                if (!p_errorMessage_2_.isEmpty()) {
                                    LOGGER.error("Error in class '{}'", (Object)p_errorMessage_1_);
    ...
    public void updateAllSounds() {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                this.categorySounds.remove((Object)isound.getCategory(), (Object)s1);
            }
            catch (RuntimeException runtimeException) {
                // empty catch block
            }
                ...
                if (this.sndSystem.getMasterVolume() <= 0.0f) {
                    ...
                    if (sound == SoundHandler.MISSING_SOUND) {
                        ...
                        if (f1 == 0.0f) {
                            ...
                            LOGGER.debug(LOG_MARKER, "Playing sound {} for event {} as channel {}", (Object)sound.getSoundLocation(), (Object)resourcelocation, (Object)s);
    ...
    public void stop(String p_189567_1_, SoundCategory p_189567_2_) {
        if (p_189567_2_ != null) {
            for (String s : this.categorySounds.get((Object)p_189567_2_)) {
                ISound isound = this.playingSounds.get(s);
