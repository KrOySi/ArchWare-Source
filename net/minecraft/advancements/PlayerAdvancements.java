...
public class PlayerAdvancements {
    ...
    private void func_192740_f() {
        if (this.field_192757_e.isFile()) {
            try {
                String s = Files.toString((File)this.field_192757_e, (Charset)StandardCharsets.UTF_8);
    ...
    public void func_192749_b() {
        ...
        try {
            Files.write((CharSequence)field_192754_b.toJson((Object)map), (File)this.field_192757_e, (Charset)StandardCharsets.UTF_8);
        }
        catch (IOException ioexception) {
