...
public class Criterion {
    ...
    public static Map<String, Criterion> func_192144_b(JsonObject p_192144_0_, JsonDeserializationContext p_192144_1_) {
        ...
        for (Map.Entry entry : p_192144_0_.entrySet()) {
            map.put(entry.getKey(), Criterion.func_192145_a(JsonUtils.getJsonObject((JsonElement)entry.getValue(), "criterion"), p_192144_1_));
        }
        return map;
    }
    ...
    public static Map<String, Criterion> func_192142_c(PacketBuffer p_192142_0_) {
        ...
        for (int j = 0; j < i; ++j) {
            map.put(p_192142_0_.readStringFromBuffer(32767), Criterion.func_192146_b(p_192142_0_));
        }
        return map;
    }
