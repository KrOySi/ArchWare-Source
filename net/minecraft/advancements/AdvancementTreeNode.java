...
public class AdvancementTreeNode {
    ...
    private void func_192320_a() {
        if (this.field_192332_e.isEmpty()) {
            this.field_192336_i = this.field_192330_c != null ? this.field_192330_c.field_192336_i + 1.0f : 0.0f;
        } else {
            AdvancementTreeNode advancementtreenode = null;
            ...
            this.func_192325_b();
            float f = (this.field_192332_e.get((int)0).field_192336_i + this.field_192332_e.get((int)(this.field_192332_e.size() - 1)).field_192336_i) / 2.0f;
    ...
    private void func_192325_b() {
        ...
        for (int i = this.field_192332_e.size() - 1; i >= 0; --i) {
            ...
            f += advancementtreenode.field_192339_l + (f1 += advancementtreenode.field_192338_k);
        }
    }
    ...
    private AdvancementTreeNode func_192324_a(AdvancementTreeNode p_192324_1_) {
        ...
        while (advancementtreenode2.func_192317_d() != null && advancementtreenode.func_192321_c() != null) {
            ...
            f1 += advancementtreenode1.field_192337_j;
        }
