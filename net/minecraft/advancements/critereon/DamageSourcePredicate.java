...
public class DamageSourcePredicate {
    ...
    public boolean func_193418_a(EntityPlayerMP p_193418_1_, DamageSource p_193418_2_) {
        ...
        if (this.field_192450_b != null && this.field_192450_b.booleanValue() != p_193418_2_.isProjectile()) {
            return false;
        }
        if (this.field_192451_c != null && this.field_192451_c.booleanValue() != p_193418_2_.isExplosion()) {
            return false;
        }
        if (this.field_192452_d != null && this.field_192452_d.booleanValue() != p_193418_2_.isUnblockable()) {
            return false;
        }
        if (this.field_192453_e != null && this.field_192453_e.booleanValue() != p_193418_2_.canHarmInCreative()) {
            return false;
        }
        if (this.field_192454_f != null && this.field_192454_f.booleanValue() != p_193418_2_.isDamageAbsolute()) {
            return false;
        }
        if (this.field_192455_g != null && this.field_192455_g.booleanValue() != p_193418_2_.isFireDamage()) {
            return false;
        }
        if (this.field_192456_h != null && this.field_192456_h.booleanValue() != p_193418_2_.isMagicDamage()) {
            return false;
        }
        if (!this.field_193419_i.func_192482_a(p_193418_1_, p_193418_2_.getSourceOfDamage())) {
            return false;
        }
    ...
    public static DamageSourcePredicate func_192447_a(@Nullable JsonElement p_192447_0_) {
        if (p_192447_0_ != null && !p_192447_0_.isJsonNull()) {
            ...
            Boolean obool = DamageSourcePredicate.func_192448_a(jsonobject, "is_projectile");
            Boolean obool1 = DamageSourcePredicate.func_192448_a(jsonobject, "is_explosion");
            Boolean obool2 = DamageSourcePredicate.func_192448_a(jsonobject, "bypasses_armor");
            Boolean obool3 = DamageSourcePredicate.func_192448_a(jsonobject, "bypasses_invulnerability");
            Boolean obool4 = DamageSourcePredicate.func_192448_a(jsonobject, "bypasses_magic");
            Boolean obool5 = DamageSourcePredicate.func_192448_a(jsonobject, "is_fire");
            Boolean obool6 = DamageSourcePredicate.func_192448_a(jsonobject, "is_magic");
