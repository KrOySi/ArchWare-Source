...
public class ItemPredicate {
    ...
    public boolean func_192493_a(ItemStack p_192493_1_) {
        ...
        if (this.field_192497_c != null && p_192493_1_.getMetadata() != this.field_192497_c.intValue()) {
            return false;
        }
        if (!this.field_192498_d.func_192514_a(p_192493_1_.func_190916_E())) {
            return false;
        }
        if (this.field_193444_e != MinMaxBounds.field_192516_a && !p_192493_1_.isItemStackDamageable()) {
            return false;
        }
        if (!this.field_193444_e.func_192514_a(p_192493_1_.getMaxDamage() - p_192493_1_.getItemDamage())) {
            return false;
        }
