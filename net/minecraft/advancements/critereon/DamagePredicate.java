...
public class DamagePredicate {
    ...
    public boolean func_192365_a(EntityPlayerMP p_192365_1_, DamageSource p_192365_2_, float p_192365_3_, float p_192365_4_, boolean p_192365_5_) {
        ...
        if (!this.field_192367_b.func_192514_a(p_192365_3_)) {
            return false;
        }
        if (!this.field_192368_c.func_192514_a(p_192365_4_)) {
            return false;
        }
        if (!this.field_192369_d.func_192482_a(p_192365_1_, p_192365_2_.getEntity())) {
            return false;
        }
        if (this.field_192370_e != null && this.field_192370_e != p_192365_5_) {
            return false;
        }
    ...
    public static DamagePredicate func_192364_a(@Nullable JsonElement p_192364_0_) {
        if (p_192364_0_ != null && !p_192364_0_.isJsonNull()) {
            JsonObject jsonobject = JsonUtils.getJsonObject(p_192364_0_, "damage");
