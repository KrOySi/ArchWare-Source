    ...
    public static MobEffectsPredicate func_193471_a(@Nullable JsonElement p_193471_0_) {
        if (p_193471_0_ != null && !p_193471_0_.isJsonNull()) {
            ...
            for (Map.Entry entry : jsonobject.entrySet()) {
                ...
                InstancePredicate mobeffectspredicate$instancepredicate = InstancePredicate.func_193464_a(JsonUtils.getJsonObject((JsonElement)entry.getValue(), (String)entry.getKey()));
