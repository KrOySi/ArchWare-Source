...
implements ITickable {
    ...
    private final ICommandSender field_193073_g = new ICommandSender(){
        ...
        public World getEntityWorld() {
            return ((FunctionManager)FunctionManager.this).field_193069_c.worldServers[0];
        }
    ...
    private void func_193061_h() {
        if (this.field_193068_b != null) {
            ...
            for (File file1 : FileUtils.listFiles((File)this.field_193068_b, (String[])new String[]{"mcfunction"}, (boolean)true)) {
                String s = FilenameUtils.removeExtension((String)this.field_193068_b.toURI().relativize(file1.toURI()).toString());
                String[] astring = s.split("/", 2);
                if (astring.length != 2) continue;
                ResourceLocation resourcelocation = new ResourceLocation(astring[0], astring[1]);
                try {
                    this.field_193070_d.put(resourcelocation, FunctionObject.func_193527_a(this, Files.readLines((File)file1, (Charset)StandardCharsets.UTF_8)));
                }
