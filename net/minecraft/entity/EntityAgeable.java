...
extends EntityCreature {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand) {
        ...
        if (itemstack.getItem() == Items.SPAWN_EGG) {
            ...
            if (!this.world.isRemote && (oclass = EntityList.field_191308_b.getObject(ItemMonsterPlacer.func_190908_h(itemstack))) != null && this.getClass() == oclass && (entityageable = this.createChild(this)) != null) {
