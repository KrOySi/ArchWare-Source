...
extends PhaseSittingBase {
    ...
    public void doClientRenderEffects() {
        ...
        if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int j = 0; j < 6; ++j) {
                    this.dragon.world.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d3, d4, d5, -vec3d.xCoord * (double)0.08f * (double)j, -vec3d.yCoord * (double)0.6f, -vec3d.zCoord * (double)0.08f * (double)j, new int[0]);
                }
    ...
    public void doLocalUpdate() {
        ...
        if (this.flameTicks >= 200) {
            ...
            float f = 5.0f;
            double d0 = this.dragon.dragonPartHead.posX + vec3d.xCoord * 5.0 / 2.0;
            double d1 = this.dragon.dragonPartHead.posZ + vec3d.zCoord * 5.0 / 2.0;
