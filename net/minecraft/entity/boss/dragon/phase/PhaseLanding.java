...
extends PhaseBase {
    ...
    public void doClientRenderEffects() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            this.dragon.world.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d3, d4, d5, -vec3d.xCoord * (double)0.08f + this.dragon.motionX, -vec3d.yCoord * (double)0.3f + this.dragon.motionY, -vec3d.zCoord * (double)0.08f + this.dragon.motionZ, new int[0]);
