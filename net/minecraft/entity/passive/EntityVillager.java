...
IMerchant {
    ...
    public static void registerFixesVillager(DataFixer fixer) {
        ...
        fixer.registerWalker(FixTypes.ENTITY, new IDataWalker(){
            ...
            public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
                ...
                if (EntityList.func_191306_a(EntityVillager.class).equals(new ResourceLocation(compound.getString("id"))) && compound.hasKey("Offers", 10) && (nbttagcompound = compound.getCompoundTag("Offers")).hasKey("Recipes", 9)) {
    ...
    private boolean hasEnoughItems(int multiplier) {
        ...
        for (int i = 0; i < this.villagerInventory.getSizeInventory(); ++i) {
            ...
            if (!flag || itemstack.getItem() != Items.WHEAT || itemstack.func_190916_E() < 9 * multiplier) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean isFarmItemInInventory() {
        for (int i = 0; i < this.villagerInventory.getSizeInventory(); ++i) {
            ItemStack itemstack = this.villagerInventory.getStackInSlot(i);
            if (itemstack.func_190926_b() || itemstack.getItem() != Items.WHEAT_SEEDS && itemstack.getItem() != Items.POTATO && itemstack.getItem() != Items.CARROT && itemstack.getItem() != Items.BEETROOT_SEEDS) continue;
            return true;
        }
        return false;
    }
