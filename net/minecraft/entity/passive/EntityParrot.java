...
implements EntityFlying {
    ...
    private static final Predicate<EntityLiving> field_192014_bH = new Predicate<EntityLiving>(){
        ...
        public boolean apply(@Nullable EntityLiving p_apply_1_) {
            return p_apply_1_ != null && field_192017_bK.containsKey(EntityList.field_191308_b.getIDForObject(p_apply_1_.getClass()));
        }
    };
    private static final Item field_192015_bI = Items.COOKIE;
    private static final Set<Item> field_192016_bJ = Sets.newHashSet((Object[])new Item[]{Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS});
    ...
    private static boolean func_192006_b(World p_192006_0_, Entity p_192006_1_) {
        if (!p_192006_1_.isSilent() && p_192006_0_.rand.nextInt(50) == 0) {
            ...
            if (!list.isEmpty() && !(entityliving = list.get(p_192006_0_.rand.nextInt(list.size()))).isSilent()) {
                SoundEvent soundevent = EntityParrot.func_191999_g(EntityList.field_191308_b.getIDForObject(entityliving.getClass()));
    ...
    static {
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityBlaze.class), (Object)SoundEvents.field_193791_eM);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityCaveSpider.class), (Object)SoundEvents.field_193813_fc);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityCreeper.class), (Object)SoundEvents.field_193792_eN);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityElderGuardian.class), (Object)SoundEvents.field_193793_eO);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityDragon.class), (Object)SoundEvents.field_193794_eP);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityEnderman.class), (Object)SoundEvents.field_193795_eQ);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityEndermite.class), (Object)SoundEvents.field_193796_eR);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityEvoker.class), (Object)SoundEvents.field_193797_eS);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityGhast.class), (Object)SoundEvents.field_193798_eT);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityHusk.class), (Object)SoundEvents.field_193799_eU);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityIllusionIllager.class), (Object)SoundEvents.field_193800_eV);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityMagmaCube.class), (Object)SoundEvents.field_193801_eW);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityPigZombie.class), (Object)SoundEvents.field_193822_fl);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityPolarBear.class), (Object)SoundEvents.field_193802_eX);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityShulker.class), (Object)SoundEvents.field_193803_eY);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySilverfish.class), (Object)SoundEvents.field_193804_eZ);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySkeleton.class), (Object)SoundEvents.field_193811_fa);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySlime.class), (Object)SoundEvents.field_193812_fb);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntitySpider.class), (Object)SoundEvents.field_193813_fc);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityStray.class), (Object)SoundEvents.field_193814_fd);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityVex.class), (Object)SoundEvents.field_193815_fe);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityVindicator.class), (Object)SoundEvents.field_193816_ff);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWitch.class), (Object)SoundEvents.field_193817_fg);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWither.class), (Object)SoundEvents.field_193818_fh);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWitherSkeleton.class), (Object)SoundEvents.field_193819_fi);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityWolf.class), (Object)SoundEvents.field_193820_fj);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityZombie.class), (Object)SoundEvents.field_193821_fk);
        field_192017_bK.put(EntityList.field_191308_b.getIDForObject(EntityZombieVillager.class), (Object)SoundEvents.field_193823_fm);
    }
}
