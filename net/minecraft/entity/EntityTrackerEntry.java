...
public class EntityTrackerEntry {
    ...
    public void updatePlayerList(List<EntityPlayer> players) {
        ...
        if (!(list = this.trackedEntity.getPassengers()).equals(this.passengers)) {
        ...
        if (playerMP != this.trackedEntity) {
            if (this.isVisibleTo(playerMP)) {
                if (!this.trackingPlayers.contains(playerMP) && (this.isPlayerWatchingThisChunk(playerMP) || this.trackedEntity.forceSpawn)) {
                    ...
                    if (this.trackedEntity instanceof EntityLivingBase) {
                        EntityEquipmentSlot[] attributemap = (EntityEquipmentSlot[])((EntityLivingBase)this.trackedEntity).getAttributeMap();
    ...
    private Packet<?> createSpawnPacket() {
        ...
        if (this.trackedEntity instanceof EntityFishHook) {
            EntityPlayer entity2 = ((EntityFishHook)this.trackedEntity).func_190619_l();
        ...
        if (this.trackedEntity instanceof EntityFireball) {
            ...
            spacketspawnobject = entityfireball.shootingEntity != null ? new SPacketSpawnObject(this.trackedEntity, i, ((EntityFireball)this.trackedEntity).shootingEntity.getEntityId()) : new SPacketSpawnObject(this.trackedEntity, i, 0);
