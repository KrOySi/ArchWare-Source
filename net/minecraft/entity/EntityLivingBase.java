...
extends Entity {
    ...
    private boolean func_190628_d(DamageSource p_190628_1_) {
        ...
        for (EnumHand enumhand : EnumHand.values()) {
            ...
            if (itemstack1.getItem() != Items.field_190929_cY) continue;
            ...
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying) {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying) {
                    if (this.isElytraFlying()) {
                        ...
                        if (this.onGround) {
                            f6 = this.world.getBlockState((BlockPos)blockpos$pooledmutableblockpos).getBlock().slipperiness * (!ncpff ? 0.91f : 0.0f);
                        }
                        ...
                        float f = f6 = !ncpff ? 0.91f : 0.3f;
                        if (this.onGround) {
                            f6 = this.world.getBlockState((BlockPos)blockpos$pooledmutableblockpos.setPos((double)this.posX, (double)(this.getEntityBoundingBox().minY - 1.0), (double)this.posZ)).getBlock().slipperiness * (!ncpff ? 0.91f : 0.913f);
                        }
                        if (this.isOnLadder()) {
                            boolean flag;
                            float f9 = 0.15f;
