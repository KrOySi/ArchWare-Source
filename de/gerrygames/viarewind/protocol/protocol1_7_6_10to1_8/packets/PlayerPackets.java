...
public class PlayerPackets {
    public static void register(Protocol protocol) {
        protocol.registerClientbound(State.PLAY, 1, 1, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 2, 2, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 5, 5, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 6, 6, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 7, 7, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 8, 8, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 31, 31, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 43, 43, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 54, 54, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 56, 56, new PacketRemapper(){
                        ...
                        for (int i = 0; i < count; ++i) {
                            ...
                            if (action == 0) {
                                ...
                                if (packetWrapper.read(Type.BOOLEAN).booleanValue()) {
                                    gameProfile2.setDisplayName(ChatUtil.jsonToLegacy(packetWrapper.read(Type.COMPONENT)));
                                }
        ...
        protocol.registerClientbound(State.PLAY, 57, 57, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 63, 63, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 67, -1, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 69, -1, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 71, -1, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 72, -1, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 1, 1, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 2, 2, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 3, 3, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 4, 4, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 5, 5, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 6, 6, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 7, 7, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 8, 8, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 10, 10, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 11, 11, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 12, 12, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 18, 18, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 19, 19, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 20, 20, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 21, 21, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 23, 23, new PacketRemapper(){
