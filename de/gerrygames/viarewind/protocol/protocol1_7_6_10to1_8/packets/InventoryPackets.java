...
public class InventoryPackets {
    public static void register(Protocol protocol) {
        protocol.registerClientbound(State.PLAY, 45, 45, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 46, 46, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 47, 47, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 48, 48, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 49, 49, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 13, 13, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 14, 14, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 15, 15, new PacketRemapper(){
        ...
        protocol.registerServerbound(State.PLAY, 16, 16, new PacketRemapper(){
