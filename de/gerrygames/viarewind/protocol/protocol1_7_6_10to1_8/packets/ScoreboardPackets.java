...
public class ScoreboardPackets {
    public static void register(Protocol protocol) {
        protocol.registerClientbound(State.PLAY, 59, 59, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 60, 60, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 61, 61, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 62, 62, new PacketRemapper(){
