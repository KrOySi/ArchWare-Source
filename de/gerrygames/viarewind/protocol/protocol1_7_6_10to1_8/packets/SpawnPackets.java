...
public class SpawnPackets {
    public static void register(Protocol protocol) {
        protocol.registerClientbound(State.PLAY, 12, 12, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 14, 14, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 15, 15, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 16, 16, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 17, 17, new PacketRemapper(){
        ...
        protocol.registerClientbound(State.PLAY, 44, 44, new PacketRemapper(){
