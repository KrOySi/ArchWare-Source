...
public enum MetaIndex1_8to1_7_6_10 {
    ...
    public static MetaIndex1_8to1_7_6_10 searchIndex(Entity1_10Types.EntityType type, int index) {
        ...
        do {
            ...
            if (!(optMeta = MetaIndex1_8to1_7_6_10.getIndex(currentType, index)).isPresent()) continue;
            return optMeta.get();
    ...
    static {
        ...
        for (MetaIndex1_8to1_7_6_10 index : MetaIndex1_8to1_7_6_10.values()) {
            metadataRewrites.put(new Pair<Entity1_10Types.EntityType, Integer>(index.getClazz(), index.getIndex()), index);
        }
    }
}
