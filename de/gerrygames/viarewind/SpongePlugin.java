...
@Plugin(id="viarewind", name="ViaRewind", version="2.0.1-SNAPSHOT", authors={"Gerrygames"}, dependencies={@Dependency(id="viaversion"), @Dependency(id="viabackwards", optional=true)}, url="https://viaversion.com/rewind")
