...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader(String fragmentShaderLocation) throws IOException {
        ...
        GL20.glAttachShader((int)program, (int)this.createShader(GLSLSandboxShader.class.getResourceAsStream("/passtrough.vsh"), 35633));
        GL20.glAttachShader((int)program, (int)this.createShader(GLSLSandboxShader.class.getResourceAsStream(fragmentShaderLocation), 35632));
