 ...
 */
package me.archware.impl.utils.font;

import java.awt.Color;
import java.awt.Font;
import java.util.ArrayList;
import java.util.List;
import me.archware.impl.utils.font.CFont;
...
extends CFont {
    ...
    public float drawStringWithShadow(String text, float x, float y, int color) {
        float shadowWidth = this.drawString(text, (double)x + 1.0, (double)y + 1.0, color, true);
